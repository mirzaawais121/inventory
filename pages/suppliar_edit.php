  ...
  <div class="content-header">
    <div class="container-fluid">
        ...
        <div class="col-md-6">
          ...
          <div class="col-md-6 mt-4">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">suppliar edit</li>
            </ol>
            </div><!-- /.col -->
            </div><!-- /.row -->
            </div><!-- /.container-fluid -->
           ...
           $data = $obj->find('suppliar' , 'id' , $edit_id);
            ...
            if ($data) {
              ...
              <div class="card-header">
                <h4 class="float-left">Update this suppliar </h4>
                <h4 class="float-right"><b>Suppliar id</b> : #<?=$data->suppliar_id;?></h4>
              </div>
               <div class="card-body">
      ...
      <form id="editSuppliarForm">
              ...
              <button type="submit" class="btn btn-primary btn-block rounded-0">Update suppliar</button>
             </form>
